...
var outputText = "Find the skydiver";
...
function preload(){
  pics[0] = loadImage("assets/tandem1.jpg");
  pics[1] = loadImage("assets/tandem2.jpg");
  pics[2] = loadImage("assets/tandem3.jpg");
